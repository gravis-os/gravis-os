...
import useStorageDropzone, {
  UseStorageDropzoneProps,
} from './useStorageDropzone'
import { File } from './types'

export interface StorageDropzoneProps extends UseStorageDropzoneProps {
